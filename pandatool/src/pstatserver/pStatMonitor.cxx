...
#ifdef _WIN32
static const Filename layout_filename = Filename::expand_from("$USER_APPDATA/Panda3D-" PANDA_ABI_VERSION_STR "/pstats-layout");
#elif defined(__APPLE__)
static const Filename layout_filename = Filename::expand_from("$HOME/Library/Caches/Panda3D-" PANDA_ABI_VERSION_STR "/pstats-layout");
#else
static const Filename layout_filename = Filename::expand_from("$XDG_CACHE_HOME/panda3d/pstats-layout");
#endif
